# -*- coding: utf-8 -*-
"""
Created on March 2 17:49:56 2019
...
def get_agent(env):
    '''
    Get DDPG agent and environment brain
    '''
    ...
    agent = qnetwork.DDPGAgent(states, actions, seed = SEED, device = device, 
...
def train_navigator(env, agent, episodes = 500, max_steps = None, epsilon_max = 1., epsilon_min = 0.01, epsilon_decay = 0.997):
    '''
    Train the agent
